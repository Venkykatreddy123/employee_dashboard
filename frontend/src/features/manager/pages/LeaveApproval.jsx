...
import { Check, X, FileText, User, Calendar, ShieldAlert, Download } from 'lucide-react';
...
const LeaveApproval = () => {
  ...
  const exportToPDF = () => {
    ...
    doc.text("Leave Approval Audit Report", 14, 22);
    
    doc.setFontSize(11);
    doc.setTextColor(100, 116, 139);
    doc.text(`Organization: EMP Logic R&D`, 14, 30);
    doc.text(`Generated By: ${user.name} (${user.role})`, 14, 35);
    ...
    autoTable(doc, {
        startY: 45,
        head: [["Employee", "Type", "Reason Snippet", "Date Requested", "Status"]],
        body: tableData,
        theme: 'striped',
    ...
    doc.save(`Leave_Audit_${new Date().toISOString().slice(0, 10)}.pdf`);
  };
    ...
    <div className="fade-in">
       <header style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
             <button className="btn btn-outline" onClick={exportToPDF}><Download size={16} /> Export PDF Audit</button>
             <button className="btn btn-primary" onClick={fetchLeaves}>Refresh Requests</button>
          </div>
       </header>
